...
visits(19185,19195)
visit(24393,"Проверь Cooking daily 70-го уровня. Рецепты из Barrel of Fish / Crate of Meat подтверждает фактическое выпадение рецепта из награды, а не показанный контейнер. Неоткрытые награды остаются отложенными.")
...
visit(25580,"Съезди к Old Man Barlo к северу от Шаттрата. Проверь fishing daily 70-го уровня; рецепты в Bag of Fishing Treasures требуют фактического loot, не просто награды-ящика.")
